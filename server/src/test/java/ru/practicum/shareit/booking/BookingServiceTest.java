...
class BookingServiceTest {
    ...
    void getOwnBookingsTest() {
        ...
        List<BookingDtoResponse> result = bookingService.getOwnBookings(BookingState.ALL, 1L, 1, 1);
        assertNotNull(result);
        assertEquals(1, result.size());

        List<BookingDtoResponse> result2 = bookingService.getOwnBookings(BookingState.REJECTED, 1L, 1, 1);
        assertNotNull(result2);
        assertTrue(result2.isEmpty());

        List<BookingDtoResponse> result3 = bookingService.getOwnBookings(BookingState.WAITING, 1L, 1, 1);
        assertNotNull(result3);
        assertTrue(result3.isEmpty());

        List<BookingDtoResponse> result4 = bookingService.getOwnBookings(BookingState.CURRENT, 1L, 1, 1);
        assertNotNull(result4);
        assertEquals(1, result4.size());

        List<BookingDtoResponse> result5 = bookingService.getOwnBookings(BookingState.PAST, 1L, 1, 1);
        assertNotNull(result5);
        assertTrue(result5.isEmpty());

        List<BookingDtoResponse> result6 = bookingService.getOwnBookings(BookingState.FUTURE, 1L, 1, 1);
    ...
    void getOwnBookingsTest_ThrowUser() {
        ...
        Throwable exception = assertThrows(
                NotFoundException.class,
                () -> bookingService.getOwnBookings(BookingState.ALL, 1L, 1, 1)
        );
    ...
    void getOwnItemsBookingsTest() {
        ...
        List<BookingDtoResponse> result = bookingService.getOwnItemsBookings(BookingState.ALL, 1L, 1, 1);
        assertNotNull(result);
        assertEquals(1, result.size());

        List<BookingDtoResponse> result2 = bookingService.getOwnItemsBookings(BookingState.REJECTED, 1L, 1, 1);
        assertNotNull(result2);
        assertTrue(result2.isEmpty());

        List<BookingDtoResponse> result3 = bookingService.getOwnItemsBookings(BookingState.WAITING, 1L, 1, 1);
        assertNotNull(result3);
        assertTrue(result3.isEmpty());

        List<BookingDtoResponse> result4 = bookingService.getOwnItemsBookings(BookingState.CURRENT, 1L, 1, 1);
        assertNotNull(result4);
        assertEquals(1, result.size());

        List<BookingDtoResponse> result5 = bookingService.getOwnItemsBookings(BookingState.PAST, 1L, 1, 1);
        assertNotNull(result5);
        assertTrue(result5.isEmpty());

        List<BookingDtoResponse> result6 = bookingService.getOwnItemsBookings(BookingState.FUTURE, 1L, 1, 1);
        assertNotNull(result6);
        assertTrue(result6.isEmpty());
    }
