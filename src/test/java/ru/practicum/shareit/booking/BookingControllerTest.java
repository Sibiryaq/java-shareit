...
class BookingControllerTest {
    ...
    void getOwnBookingsTest() throws Exception {
        ...
        when(bookingService.getOwnBookings(anyString(), anyLong(), anyInt(), anyInt()))
        ...
        verify(bookingService, times(1)).getOwnBookings(anyString(), anyLong(), anyInt(), anyInt());
    }
    ...
    void getOwnItemsBookingsTest() throws Exception {
        ...
        when(bookingService.getOwnItemsBookings(anyString(), anyLong(), anyInt(), anyInt()))
                .thenReturn(responses);
        ...
        mvc.perform(get("/bookings/owner")
                ...
                .andExpect(jsonPath("$", Matchers.hasSize(1)))
                .andExpect(jsonPath("$.[0].id", Matchers.is(responses.get(0).getId()), Long.class));
        verify(bookingService, times(1)).getOwnItemsBookings(anyString(), anyLong(), anyInt(), anyInt());
    }
